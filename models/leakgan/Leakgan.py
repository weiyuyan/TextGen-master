...
class Leakgan(Gan):
    def __init__(self, oracle=None):
        ...
        self.sequence_length = FLAGS.length     # DSD:设置序列长度，这里默认为20
        self.filter_size = [2, 3]       # DSD:设置卷积核的大小
        self.num_filters = [100, 200]   # DSD:设置卷积核数量
        self.l2_reg_lambda = 0.2    # DSD:L2范数, L1可以得到稀疏的权值,L2可以得到平滑的权值
        self.dropout_keep_prob = 0.75   # DSD:留75%
        self.batch_size = 64
        ...
        self.oracle_file = 'save/oracle.txt'    # DSD:oracle是啥文件啊看不懂
        self.generator_file = 'save/generator.txt'
        self.test_file = 'save/test_file.txt'

    def init_oracle_trainng(self, oracle=None):
        goal_out_size = sum(self.num_filters)   # DSD:卷积数求和
